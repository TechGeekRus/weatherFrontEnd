...
function Home() {
  ...
  useEffect(() => {
    // Your entire Bird definition as given (no changes here)
    const Bird = {
      def: function(n, m, s) {
    ...
    function drawFrame() {
      ...
      ctx.translate(Bird.canv.w / 2, Bird.canv.h / 2);
      ctx.clearRect(-Bird.canv.w / 2, -Bird.canv.h / 2, Bird.canv.w, Bird.canv.h);
      ctx.scale(1, -1);
      const arr = [];
  ...
  return (
    <div style={{ padding: '50px', fontFamily: 'Arial, sans-serif', color: 'white' }}>
